...
def get_options() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        "--output",
        metavar="<path>",
        help="output file with lineage info",
        default = "lineage_info.txt"
    )
...
def main():
    ...
    output = lineage_df.melt(value_vars=["species", "genus", "family", "order"], var_name="Category", value_name="Name")["Name"]
